...
- (id)initWithDelegate:(id<ZXingDelegate>)scanDelegate showCancel:(BOOL)shouldShowCancel OneDMode:(BOOL)shouldUseoOneDMode withCrop:(CGRect)crop {
  self = [super init];
  if (self) {
...
{ 
  ...
  CGImageRef newImage = CGImageCreateWithImageInRect(capture, self.cropRect);
